...
import com.example.weixin.cp.bean.WxCpTpTag;
import com.example.weixin.cp.bean.WxCpTpTagAddOrRemoveUsersResult;
import com.example.weixin.cp.bean.WxCpTpTagGetResult;
import com.example.weixin.cp.config.WxCpTpConfigStorage;
import com.example.weixin.cp.tp.service.WxCpTpService;
import com.example.weixin.cp.tp.service.WxCpTpTagService;
import com.example.weixin.cp.util.json.WxCpGsonBuilder;

import java.util.List;

import static com.example.weixin.cp.constant.WxCpApiPathConsts.Tag.*;
