...
import com.example.weixin.common.error.WxCpErrorMsgEnum;
...
import com.example.weixin.common.util.http.SimpleGetRequestExecutor;
...
import com.example.weixin.cp.bean.*;
import com.example.weixin.cp.config.WxCpTpConfigStorage;
import com.example.weixin.cp.tp.service.*;
...
import static com.example.weixin.cp.constant.WxCpApiPathConsts.Tp.*;
