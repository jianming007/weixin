...
import com.example.weixin.common.api.WxMessageDuplicateChecker;
import com.example.weixin.common.api.WxMessageInMemoryDuplicateChecker;
import com.example.weixin.common.session.InternalSession;
import com.example.weixin.common.session.InternalSessionManager;
import com.example.weixin.common.session.WxSessionManager;
import com.example.weixin.common.util.LogExceptionHandler;
...
public class WxCpMessageRouter {
  ...
  /**
   * <pre>
   * 设置自定义的 {@link com.example.weixin.common.api.WxMessageDuplicateChecker}
   * 如果不调用该方法，默认使用 {@link com.example.weixin.common.api.WxMessageInMemoryDuplicateChecker}
   * </pre>
   */
  ...
  /**
   * <pre>
   * 设置自定义的{@link com.example.weixin.common.session.WxSessionManager}
   * 如果不调用该方法，默认使用 {@link com.example.weixin.common.session.StandardSessionManager}
   * </pre>
   */
  ...
  /**
   * <pre>
   * 设置自定义的{@link com.example.weixin.common.api.WxErrorExceptionHandler}
   * 如果不调用该方法，默认使用 {@link com.example.weixin.common.util.LogExceptionHandler}
   * </pre>
   */
