...
import lombok.Data;
import com.example.weixin.common.api.WxConsts.KefuMsgType;
import com.example.weixin.cp.bean.article.MpnewsArticle;
import com.example.weixin.cp.bean.article.NewArticle;
import com.example.weixin.cp.bean.messagebuilder.*;
import com.example.weixin.cp.bean.taskcard.TaskCardButton;
import com.example.weixin.cp.bean.templatecard.*;
...
import static com.example.weixin.common.api.WxConsts.KefuMsgType.*;
