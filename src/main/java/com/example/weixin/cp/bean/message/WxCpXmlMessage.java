...
import com.example.weixin.common.util.XmlUtils;
import com.example.weixin.common.util.xml.IntegerArrayConverter;
import com.example.weixin.common.util.xml.LongArrayConverter;
...
public class WxCpXmlMessage implements Serializable {
  ...
  /**
   * 通讯录变更事件.
   * 请参考常量 com.example.weixin.cp.constant.WxCpConsts.ContactChangeType
   */
