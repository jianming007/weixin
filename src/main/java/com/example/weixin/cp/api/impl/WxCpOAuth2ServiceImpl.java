...
import com.example.weixin.common.util.http.URIUtil;
import com.example.weixin.common.util.json.GsonHelper;
import com.example.weixin.common.util.json.GsonParser;
import com.example.weixin.cp.api.WxCpOAuth2Service;
import com.example.weixin.cp.api.WxCpService;
import com.example.weixin.cp.bean.WxCpOauth2UserInfo;
import com.example.weixin.cp.bean.WxCpUserDetail;
import com.example.weixin.cp.util.json.WxCpGsonBuilder;

import static com.example.weixin.common.api.WxConsts.OAuth2Scope.*;
import static com.example.weixin.cp.constant.WxCpApiPathConsts.OAuth2.*;
