...
import com.example.weixin.cp.bean.oa.*;
...
public interface WxCpOaService {
   ...
   * @return WxCpApprovalInfo approval info
   * @throws WxErrorException .
   * @see com.example.weixin.cp.api.WxCpOaService#getApprovalInfo com.example.weixin.cp.api.WxCpOaService#getApprovalInfo
   */
