...
import com.example.weixin.cp.bean.WxCpInviteResult;
import com.example.weixin.cp.bean.WxCpUser;
import com.example.weixin.cp.bean.external.contact.WxCpExternalContactInfo;
import com.example.weixin.cp.util.json.WxCpGsonBuilder;

import java.util.List;
import java.util.Map;

import static com.example.weixin.cp.constant.WxCpApiPathConsts.User.*;
