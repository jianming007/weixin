...
public interface WxCpService extends WxService {
   ...
   * WxCpService默认使用的是{@link com.example.weixin.common.session.StandardSessionManager}
   * </pre>
   *
