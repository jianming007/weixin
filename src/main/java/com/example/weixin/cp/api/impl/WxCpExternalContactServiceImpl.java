...
import com.example.weixin.common.util.BeanUtils;
import com.example.weixin.common.util.json.GsonParser;
import com.example.weixin.cp.api.WxCpExternalContactService;
import com.example.weixin.cp.api.WxCpService;
import com.example.weixin.cp.bean.WxCpBaseResp;
import com.example.weixin.cp.bean.external.*;
import com.example.weixin.cp.bean.external.contact.*;
...
import static com.example.weixin.cp.constant.WxCpApiPathConsts.ExternalContact.*;
