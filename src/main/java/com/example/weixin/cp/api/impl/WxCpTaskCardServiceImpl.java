...
import com.example.weixin.cp.api.WxCpTaskCardService;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import static com.example.weixin.cp.constant.WxCpApiPathConsts.TaskCard.*;
import static com.example.weixin.cp.constant.WxCpApiPathConsts.TaskCard.UPDATE_TASK_CARD;
